...
import com.luthfirr.sub1intermediate.database.RemoteKeys
...
class StoryRemoteMediator(
    ...
    override suspend fun load(
        ...
        try {
            val responseData = apiService.getStoriesPaging3("Bearer $token", page, state.config.pageSize).listStory as List<ListStoryItem>
